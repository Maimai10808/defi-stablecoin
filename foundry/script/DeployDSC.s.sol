...
import {SeedLocalWalletBalances} from "./SeedLocalWalletBalances.s.sol";
...
contract DeployDSC is Script {
        ...
        )
    {
        ...
        if (block.chainid == 31337) {
            SeedLocalWalletBalances seeder = new SeedLocalWalletBalances();
            seeder.seed(weth, wbtc, deployerKey);
        }
